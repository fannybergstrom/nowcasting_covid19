...
err_b_7 <- matrix(NA, length(N_mod_b), 7)
log_b_7 <- matrix(NA, length(N_mod_b), 7)
crps_b_7 <- matrix(NA, length(N_mod_b), 7)
for(i in 1:length(N_mod_a)){
  for(j in 1:7){
...
err_b_c_7 <- matrix(NA, length(N_mod_b), 7)
log_b_c_7 <- matrix(NA, length(N_mod_b), 7)
crps_b_c_7 <- matrix(NA, length(N_mod_b), 7)
for(i in 1:length(N_mod_a)){
  for(j in 1:7){
...
err_c_7 <- matrix(NA, length(N_mod_c), 7)
log_c_7 <- matrix(NA, length(N_mod_c), 7)
crps_c_7 <- matrix(NA, length(N_mod_c), 7)
for(i in 1:length(N_mod_c)){
  for(j in 1:7){
