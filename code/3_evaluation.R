...
model_spec <- c("mod_a_cp", "mod_b_cp", "mod_c_cp", "mod_d_cp,")
...
files_mod_c <- list_files("N", "mod_c_cp")[1:n]
files_mod_d <- list_files("N", "mod_d_new")[1:n]
#files_mod_d_new <- list_files("N", "mod_d_new")[1:140]
files_mod_e <- list_files("N", "mod_e")[1:n]
